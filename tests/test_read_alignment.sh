#Introduction
cd /home/manager/course_data/read_alignment/data
samtools --help
bwa
picard -h
#igv &
...
samtools view -C -T ../../../ref/Saccharomyces_cerevisiae.R64-1-1.dna.toplevel.fa.gz -o library1.markdup.cram library1.markdup.bam
