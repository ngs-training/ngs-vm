...
zcat  genome/gencode.v18.annotation.gtf | awk '$3=="gene"' > genome/gencode.v18.annotation.genes.gtf
...
less genome/gencode.v18.annotation.genes.gtf | awk 'BEGIN {FS=OFS="\t"} { if($7=="+"){tss=$4-1} else { tss = $5 } print $1,tss, tss+1, ".", ".", $7, $9}' > genome/gencode.tss.bed
